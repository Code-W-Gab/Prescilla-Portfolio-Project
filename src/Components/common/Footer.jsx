  ...
  return(
    <footer className='flex gap-10'>
      <div>
        ...
        <p className='text-md w-110'>Ready to reclaim your time and focus on what matters most? Let's chat about how I can support your business goals.</p>
      </div>
      <div className='grid grid-cols-2 items-center sans'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <p>Calendly</p>
            <p className='underline sans font-semibold'>Book a call</p>
          </div>
        </div>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <p>Email</p>
            <p className='underline sans font-semibold'>vaprescillasamorin@gmail.com</p>
          </div>
        </div>
      ...
      <div className="bg-amber-300 border-r-2 h-35"></div>

      <div>
        <h1 className='text-sm font-bold'>VISIT MY SOCIALS:</h1>
